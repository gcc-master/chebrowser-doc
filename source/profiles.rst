...
.. tip::
   ...
   | Если Вы только приобрели профиль, то кнопка будет не активной.
   | Что бы получить возможность импорта и экспорта кук просто запустите браузер с текущим профилем.
