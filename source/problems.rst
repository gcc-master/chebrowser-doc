...
- если у Вас отключена служба Windows Update, то запускаете ее
- скачайте update **KB2670838** по ссылке https://www.microsoft.com/en-us/download/details.aspx?id=36805
- установите
- перезагрузите систему
- отключаете службу Windows Update если Вам это необходимо
...
Если у Вас в системе установлен proxifier и Вы наблюдаете ошибки при работе с che browser, то отключите proxifier и попробуйте перезапустить che browser.
